...
function data_fetch(){
$args  =  get_terms(array('taxonomy' => 'residence_tex',
						 ));
if($args){
	
 foreach($args as $term_single): ?>
<li class="location"><?php  echo $types = $term_single->name;?></li><?php endforeach;
}
}
...
function theme_scripts() {
    ...
    wp_enqueue_script( 'min', get_template_directory_uri() . '/assets/js/custom.js' ,array(),1,true );
